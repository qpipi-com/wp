 ...
 * @LastEditTime: 2023-04-03 00:40:15
         * 子比主题的媒体管理工具，只能用于前台
         * 
         * 依赖函数：
         * notice() ：前台通知函数，已经复制
        ...
        this.createList = function (data, add_class) {
            ...
            switch (this.type) {
                ...
                default:
                    ...
                    var desc_2 = data.filesizeInBytes ? format_size(data.filesizeInBytes) : '';
        ...
        function mainInit(element) {
            ...
            function hiddenNameRefresh() {
                ...
                $lists_box.find('.lists-item').each(function (index) {
                    $(this).find('[data-depend-id]').each(function () {
                        var $this = $(this);
            ...
            function classChoice(val) {
                ...
                $modal_body.find('.class-choice[data-val="' + val + '"]').addClass('is-active').siblings().removeClass('is-active');
            }
    ...
    //--------------------------上传文件-------------------------------
    PluginManagerAdd('zib_file', function (editor, url) {
        ...
        function setContent(file_id, href, filename, icon, desc_1, desc_2) {
            ...
            var suffix = '<p></p>';
            var html = '<div class="mb20 muted-box file-download-box" contenteditable="false"><div class="flex ac jsb">\
            <div class="flex ac">\
            <div class="mr10"><div class="file-download-icon">' + icon + '</div></div>\
    <div class="text-ellipsis-2 file-download-name" contenteditable="true">' + filename + '</div>\
        </div>\
            <div class="flex0 ml20">\
                <a href="' + href + '" data-mce-href="' + href + '" ' + file_id + ' class="but c-blue file-download-btn"><i class="fa fa-download"></i>下载</a>\
            </div>\
        </div>\
        ' + desc + '</div>';
